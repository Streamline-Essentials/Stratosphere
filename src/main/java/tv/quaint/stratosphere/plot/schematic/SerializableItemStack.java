...
public class SerializableItemStack {
    ...
    public SerializableItemStack(ItemStack from) {
    ...
    public SerializableItemStack(FlatFileSection section) {
    ...
    public SerializableItemStack(String material, int count, String name, List<String> lore, ConcurrentHashMap<String, Integer> enchants) {
